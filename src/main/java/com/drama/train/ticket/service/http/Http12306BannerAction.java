...
@Log4j2
public class Http12306BannerAction extends AbstractHttpAction {

    public Http12306BannerAction(Http12306Config http12306Config) {
    ...
    public URI prepareUrl(HttpParameter httpParameter) {
        try {
            URIBuilder uriBuilder = new URIBuilder()
                    ...
                    .setPath(http12306Config.getBannerUrl());
